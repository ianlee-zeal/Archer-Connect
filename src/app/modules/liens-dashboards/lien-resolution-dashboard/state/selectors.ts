...
const dashboardFeatureSelector = createSelector(dashboardFeature, state => state.lienResolutionDashboard);
...
export const lienDashboardClearActionFilters = createSelector(dashboardFeature, state => state.lienResolutionDashboard.lienDashboardClearActionFilters);
