...
export interface LienResolutionDashboardState {
  ...
  lienDashboardClearActionFilters: KeyValuePair<string, string>[],
  activeFilter: DashboardFilters
}

export const lienResolutionDashboardState: LienResolutionDashboardState = {
  phasesSummary: null,
  stagesSummary: null,
  typesSummary: null,
  actionBar: null,
  ...
  lienDashboardClearActionFilters: null,
  activeFilter: null
};
...
const Reducer = createReducer(
  ...
  on(actions.UpdateLienDashboardClearActionFilters, (state, { filters }) => ({ ...state, lienDashboardClearActionFilters: filters })),

  on(actions.ResetFilters, state => ({ ...state, activeFilter: null, selectedPhases: null, selectedStages: null, selectedTypes: null, lienDashboardClearActionFilters: null })),
...
export function reducer(state: LienResolutionDashboardState | undefined, action: Action) {
