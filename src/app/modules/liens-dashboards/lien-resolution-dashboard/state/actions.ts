...
const featureName = '[LienResolutionDashboard]';
...
export const UpdateLienDashboardClearActionFilters = createAction(`${featureName} Update Lien Dashboard Clear Action`, props<{ filters: KeyValuePair<string, string>[] }>());
