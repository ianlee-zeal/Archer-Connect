...
export interface ProbateDashboardState {
  ...
  probateDashboardClearActionFilters: KeyValuePair<string, string>[],
  activeFilter: DashboardFilters
}

export const probateDashboardState: ProbateDashboardState = {
  phasesSummary: null,
  ...
  probateDashboardClearActionFilters: null,
  activeFilter: null
};

const Reducer = createReducer(
  probateDashboardState,
  on(actions.GetStatusesSummary, (state, { lienTypes, lienPhases }) => ({ ...state, selectedTypes: lienTypes, selectedPhases: lienPhases, statusesSummary: null, error: null })),
  on(actions.GetStatusesSummarySuccess, (state, { summary }) => ({ ...state, statusesSummary: summary, filtersProjectId: state.project && state.project.id, error: null })),

  on(actions.GetPhasesSummary, (state, { lienTypes, lienPhases, clientStatuses }) => ({ ...state, selectedStatuses: clientStatuses, selectedTypes: lienTypes, selectedPhases: lienPhases, phasesSummary: null, error: null })),
  ...
  on(actions.GetTypesSummary, (state, { lienPhases, clientStatuses }) => ({ ...state, selectedStatuses: clientStatuses, selectedPhases: lienPhases, typesSummary: null, error: null })),
  ...
  on(actions.UpdateProbateDashboardClearActionFilters, (state, { filters }) => ({ ...state, probateDashboardClearActionFilters: filters })),

  on(actions.ResetFilters, state => ({ ...state, activeFilter: null, selectedPhases: null, selectedStatuses: null, selectedTypes: null, probateDashboardClearActionFilters: null })),
...
export function reducer(state: ProbateDashboardState | undefined, action: Action) {
