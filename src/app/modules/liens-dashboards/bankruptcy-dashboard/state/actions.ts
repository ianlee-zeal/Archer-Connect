...
const featureName = '[BankruptcyDashboard]';

export const GetStagesSummary = createAction(`${featureName} Get Stages Summary`, props<{ rootProductCategoryId: number, projectId: number, lienTypes?: number[], lienPhases?: number[], bypassSpinner?: boolean }>());
export const GetStagesSummarySuccess = createAction(`${featureName} Get Stages Summary Success`, props<{ summary: LienStatusSummary }>());

export const GetPhasesSummary = createAction(`${featureName} Get Phases Summary`, props<{ rootProductCategoryId: number, projectId: number, lienTypes?: number[], lienPhases?: number[], clientStages?: number[] }>());
export const GetPhasesSummarySuccess = createAction(`${featureName} Get Phases Summary Success`, props<{ summary: LienPhaseSummary }>());

export const GetTypesSummary = createAction(`${featureName} Get Types Summary`, props<{ rootProductCategoryId: number, projectId: number, lienPhases?: number[], clientStages?: number[] }>());
...
export const UpdateBankruptcyDashboardClearActionFilters = createAction(`${featureName} Update Bankruptcy Dashboard Clear Action`, props<{ filters: KeyValuePair<string, string>[] }>());
