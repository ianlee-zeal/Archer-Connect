...
const featureName = '[Release Dashboard Claimants]';
export const gridFeatureName = `${featureName} [Grid]`;

export const GetClaimantsList = createAction(`${featureName} Get Claimants List`, props<{ projectId: number, rootProductCategoryId:number, agGridParams?: IServerSideGetRowsParamsExtended, lienTypes?: number[], lienPhases?: number[], clientStages?: number[], isReleaseInGoodOrder?: boolean }>());
