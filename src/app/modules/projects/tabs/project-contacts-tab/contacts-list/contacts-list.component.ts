...
export class ContactsListComponent extends ListView implements OnInit {
  ...
  protected fetchData(params): void {
    ...
    this.store.dispatch(actions.GetContactsList({ projectId: this.projectId, agGridParams: params }));
  }
