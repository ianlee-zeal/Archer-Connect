...
@Component({
  selector: 'app-update-by-action-template-id-updates-list',
  templateUrl: './update-by-action-template-id-updates-list.component.html',
})
export class UpdateByActionTemplateIdUpdatesListComponent extends ListView {
  ...
  protected fetchData(agGridParams: IServerSideGetRowsParamsExtended): void {
    this.store.dispatch(projectActions.GetBatchActionResultRequest({
      ...
      agGridParams,
      status: BatchActionResultStatus.Updated,
    }));
  }
}
