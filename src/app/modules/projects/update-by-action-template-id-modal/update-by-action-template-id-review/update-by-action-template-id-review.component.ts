...
@Component({
  selector: 'app-update-by-action-template-id-review',
  templateUrl: './update-by-action-template-id-review.component.html',
  styleUrls: ['./update-by-action-template-id-review.component.scss'],
})
export class UpdateByActionTemplateIdReviewComponent implements OnInit {
