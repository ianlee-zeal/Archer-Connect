...
import * as selectors from '../../../projects/state/selectors';
...
@Component({
    selector: 'app-copy-special-payment-instructions-selected-list',
    templateUrl: './copy-special-payment-instructions-selected-list.component.html',
})
export class CopySpecialPaymentInstructionsSelectedListComponent extends ListView implements OnInit, OnDestroy {
    ...
    public readonly gridId: GridId = GridId.ProjectCopySpecialPaymentInstructionsList;
